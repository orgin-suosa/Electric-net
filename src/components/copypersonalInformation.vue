  ...
  <div id="personal">
    ...
    <div v-show="isCardContent" class="per_box">
                ...
                <div v-if="cardListData.isCardSelect&&cardListData.ISOPENJHS=='1'">
                  <ul>
                    ...
                    >
                      ...
                      <div
                        style="display:flex;display:-webkit-flex;height:40px;"
                        v-else
      ...
      <div class="send_btn">
        ...
        <div v-else>
          <el-button class="btn_style" type="primary" @click="sendNote" plain>
            <i class="iconfont icon-duanxin1"></i>&nbsp;短信发送
          </el-button>
          <el-button class="btn_style" type="primary" @click="NotePreview" plain>
...
export default {
  ...
  methods: {
    ...
    enterPage() {
      ...
      // this.hallid = this.starNumTwo.hallid;
    },
    //足迹添加样式内容
    clientFooterList() {},
    //可选内容区选择事件
    ...
    newmodelListterId() {
      ...
      // let codeList = JSON.parse(window.localStorage.getItem("codeList"));
      // console.log('员工编号'+codeList.result);
